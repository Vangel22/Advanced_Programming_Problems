...
class Component implements Comparable<Component>{
    ...
    public void changeColor(int weight, String color){
        ...
        components.forEach(k -> k.changeColor(weight,color));
    }
...
class Window{
    ...
    public void changeColor(int weight, String color){
        components.values().forEach(k -> k.changeColor(weight,color));
    }

    //get ja zema vrednosta na taa pozicija
    ...
    public String toString() {
        ...
        components.entrySet().forEach(e -> sb.append(e.getKey() +":"+ e.getValue()));
        return sb.toString();
    }
...
class InvalidPositionException extends Throwable{
    ...
    public String getMessage() {
        return "Invalid position "+position+", alredy taken!";
    }
}